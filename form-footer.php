<div id="form-ftr">
    ...
    <form action="mail.php" method="post" name="form" id="myForm">
        ...
        <input type="tel" name="phone" id="phone" pattern="[0-9]{10}" maxlength="10" class="form-control2"
       ...
       <input type="hidden" name="form_name" id="form_name" class="form-control" value="Footer">
        ...
        <button type="submit" name="submit" value="submit" class="form-control2" id="frm-submit">Submit</button>
    </form>
</div>